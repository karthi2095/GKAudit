...
<body>
		...
		<div class="table-div">
			<form name="tqm-team" method="post" action="">
				<table cellpadding="0" cellspacing="0">
					...
					<input type="hidden" name="Commentidtqm" id="Commentidtqm"
							value="<?php echo $commenttqm['Comment_id'];?>">
						<tr >
						...
						<tr >
							<td colspan="7" class="item2"><textarea rows="7" cols="50" id="diagnosis_result_tqm" name="diagnosis_result_tqm" style="width: 99%;" ><?php echo stripslashes($commenttqm['Diagnosis_Result']); ?></textarea></td>
							<td colspan="6" class="item2"><textarea rows="7" cols="50" id="kaizen_idea_tqm" name="kaizen_idea_tqm" style="width: 99%;" ><?php echo stripslashes($commenttqm['Kaizen_Idea']); ?></textarea></td>
						</tr>
						<!--- for comments form auditor  ------------->
							...
							<td class="padd0 text-center"><select name="tm_51" id="tm_51"
								onchange="return teamwork_level51(this); actualscore5();">
									<option value="0" <?php if($leveltm51['Audit_Check'] == 0){?>
										selected="selected" <?php }?>>0</option>
									<option value="1" <?php if($leveltm51['Audit_Check'] == 1){?>
										selected="selected" <?php }?>>1</option>
							</select>
							</td>
					...
					<input type="hidden" name="Commentidtm" id="Commentidtm"
							value="<?php echo $commenttm['Comment_id'];?>">
						<tr >
						...
						<tr >
							<td colspan="7" class="item2"><textarea rows="7" cols="50" id="diagnosis_result_tm" name="diagnosis_result_tm" style="width: 98%;" ><?php echo $commenttm['Diagnosis_Result']; ?></textarea></td>
							<td colspan="6" class="item2"><textarea rows="7" cols="50" id="kaizen_idea_tm" name="kaizen_idea_tm" style="width: 98%;" ><?php echo $commenttm['Kaizen_Idea']; ?></textarea></td>
						</tr>
						<!--- for comments form auditor  ------------->
						<tr class="item1">
	...
	?>
				...
				<button type="button" id="btnsub" class="next" onclick="return validatecomments();">Submit</button>
				</div>
			</form>
